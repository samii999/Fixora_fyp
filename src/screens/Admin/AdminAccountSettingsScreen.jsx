...
const AdminAccountSettingsScreen = ({ navigation }) => {
  const { user } = useAuth();
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {userData.organizationName && (
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoHelper}>As an admin, you manage this organization</Text>
          </View>
        )}
...
export default AdminAccountSettingsScreen;
