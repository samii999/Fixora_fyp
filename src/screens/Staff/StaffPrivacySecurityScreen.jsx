...
const StaffPrivacySecurityScreen = ({ navigation }) => {
  const { user } = useAuth();
  ...
  const handleExportData = () => {
    Alert.alert(
      'Export Data',
      'Your data export request has been received. You will receive an email with your data within 24-48 hours.',
      [{ text: 'OK' }]
    );
  };
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            Alert.alert(
              'Contact Admin',
              'Please contact your organization administrator to request account deletion.',
              [{ text: 'OK' }]
            );
          },
        },
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingDescription}>
                Allow location tracking for task assignments
              </Text>
            </View>
            <Switch
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingDescription}>
                Share work data with your organization
              </Text>
            </View>
            <Switch
          ...
          <TouchableOpacity style={styles.actionItem} onPress={handleExportData}>
            <View style={styles.actionInfo}>
              ...
              <View style={styles.actionTextContainer}>
                ...
                <Text style={styles.actionDescription}>
                  Download a copy of your work data
                </Text>
              </View>
            </View>
            <Text style={styles.chevron}>›</Text>
...
export default StaffPrivacySecurityScreen;
