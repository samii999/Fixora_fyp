...
const StaffProfileScreen = () => {
  ...
  const handleSettingPress = (setting) => {
    switch (setting) {
      case 'account':
        navigation.navigate('StaffAccountSettings');
        break;
      case 'notifications':
        navigation.navigate('StaffNotificationSettings');
        break;
      case 'privacy':
        navigation.navigate('StaffPrivacySecurity');
        break;
      case 'help':
        navigation.navigate('StaffHelpSupport');
        break;
      case 'about':
        Alert.alert('About', 'Fixora Staff v1.0.0\nIssue Management System');
        break;
      default:
        break;
    }
